    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionBlock", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DateCreated = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2017, 1, 22, 13, 43, 17, 687, DateTimeKind.Utc)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DivisionId = table.Column<int>(nullable: false),
                    QuestionBlockId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Question_Division_DivisionId",
                        column: x => x.DivisionId,
                        principalTable: "Division",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Question_QuestionBlock_QuestionBlockId",
                        column: x => x.QuestionBlockId,
                        principalTable: "QuestionBlock",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateUploaded = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2017, 1, 22, 13, 43, 17, 680, DateTimeKind.Utc)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answer_Document_DocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Question_DivisionId",
                table: "Question",
                column: "DivisionId");

            migrationBuilder.CreateIndex(
                name: "IX_Question_QuestionBlockId",
                table: "Question",
